...
The checked-in artifacts are generated by `typeclaw-data`:
...
They contain character n-gram probabilities, dictionary word-frequency maps,
and dictionary prefix-evidence maps, not raw subtitle files. Rebuild them with:
